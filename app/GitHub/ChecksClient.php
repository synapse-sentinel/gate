...
MARKDOWN;
    ...
    /**
     * Post an actionable prompt comment on a PR for failures.
     *
     * This is the core of the "directions for completion" philosophy -
     * instead of just saying "FAIL", we tell developers HOW to fix it.
     */
    public function postActionablePrompt(string $prompt): bool
    {
        if (! $this->isAvailable() || $this->prNumber === null) {
            return false;
        }
...
---
<sub>🤖 Generated by Synapse Sentinel - [View Run](https://github.com/{$this->repo}/actions)</sub>
MARKDOWN;
